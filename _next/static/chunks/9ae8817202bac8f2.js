...
`,meta:{attribution:"Adapted from sketch by @XorDev"}},rocaille:{name:"Rocaille",description:"Layered trigonometric filigree with spatial phase offsets",sim:`
in vec2 vUv;
out vec4 fragColor;
...
`,meta:{attribution:"Adapted from sketch by @XorDev"}},rocailleGlitch:{name:"Rocaille Glitch",description:"Rocaille filigree remixed with Event 2-style quantized warping and feedback",sim:`
in vec2 vUv;
out vec4 fragColor;
...
`,meta:{attribution:"Adapted from sketch by @XorDev"}},cathedralMist:{name:"Cathedral Mist",description:"Volumetric cosine folds with refracted inner turbulence",sim:`
in vec2 vUv;
out vec4 fragColor;
...
`,meta:{attribution:"Adapted from sketch by @XorDev"}},eventideHelix:{name:"Eventide Helix",description:"Stepped oscillatory field with sine-warped feedback trails",sim:`
in vec2 vUv;
out vec4 fragColor;
...
`,meta:{attribution:"Adapted from sketch by @XorDev"}},emberArray:{name:"Ember Array",description:"Dense orbital fold cloud with chromatic ray accumulation",sim:`
in vec2 vUv;
out vec4 fragColor;
...
`,meta:{attribution:"Adapted from sketch by @XorDev"}},silkSpindle:{name:"Silk Spindle",description:"Cross-product drift lattice disturbed by quantized cosine pulses",sim:`
in vec2 vUv;
out vec4 fragColor;
...
`,meta:{attribution:"Adapted from sketch by @XorDev"}},axialChoir:{name:"Axial Choir",description:"Rotated ray bundle with anisotropic depth and harmonic tinting",sim:`
in vec2 vUv;
out vec4 fragColor;
...
`,meta:{attribution:"Adapted from sketch by @XorDev"}},prismTangle:{name:"Prism Tangle",description:"Rounded fold filigree with radial prism-like grading",sim:`
in vec2 vUv;
out vec4 fragColor;
...
`,meta:{attribution:"Adapted from sketch by @XorDev"}},noctilucentArc:{name:"Noctilucent Arc",description:"Phase-shifted shell growth with sinusoidal volumetric trails",sim:`
in vec2 vUv;
out vec4 fragColor;
...
`,meta:{attribution:"Adapted from sketch by @XorDev"}},furnaceMire:{name:"Furnace Mire",description:"Chaotic folded plasma with rounded-step harmonic diffusion",sim:`
in vec2 vUv;
out vec4 fragColor;
