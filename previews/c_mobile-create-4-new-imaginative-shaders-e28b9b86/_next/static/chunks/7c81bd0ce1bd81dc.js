...
`,meta:{attribution:"Adapted from sketch by @XorDev"}},chiaroscuroBloom:{name:"Chiaroscuro Bloom",description:"Ink-like light and shadow plumes with reactive bloom",sim:`
in vec2 vUv;
out vec4 fragColor;
...
`},eclipseWeave:{name:"Eclipse Weave",description:"Interlaced corona rings and umbral cores orbiting the cursor",sim:`
in vec2 vUv;
out vec4 fragColor;
...
`},umbraDrift:{name:"Umbra Drift",description:"Foggy advection field where darkness carves flowing channels",sim:`
in vec2 vUv;
out vec4 fragColor;
...
`},lumenGlyphs:{name:"Lumen Glyphs",description:"Thresholded harmonic glyphs suspended in neon turbulence",sim:`
in vec2 vUv;
out vec4 fragColor;
